...
namespace VolunteerManagement.Infrastructure.Migrations
{
    ...
    [Migration("20260128155515_AddPhotosToVolunteerAndPet")]
    partial class AddPhotosToVolunteerAndPet
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VolunteerManagement.Domain.Aggregates.Volunteers.Volunteer", b =>
                {
                    ...
                    b.Property<IReadOnlyList<Photo>>("Photos")
                        .IsRequired()
                        .HasColumnType("jsonb")
            ...
            modelBuilder.Entity("VolunteerManagement.Domain.Aggregates.Volunteers.Entities.Pet", b =>
                {
                    ...
                    b.OwnsMany("VolunteerManagement.Domain.Aggregates.Volunteers.ValueObjects.Properties.Photo", "PetPhotoList", b1 =>
                        {
                            b1.Property<Guid>("PetId")
                                .HasColumnType("uuid");

        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PetNickName = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PetAdoptionStates", x => x.CorrelationId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VolunteerAssignments_Shelters_ShelterId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    VolunteerId = table.Column<Guid>(type: "uuid", nullable: false),
                    NickName = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    Description = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    ...
                    BookerId = table.Column<Guid>(type: "uuid", nullable: true),
                    ShelterId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PetAdoptionStates_AdopterId",
                table: "PetAdoptionStates",
                column: "AdopterId");

            migrationBuilder.CreateIndex(
                name: "IX_PetAdoptionStates_CurrentState",
                table: "PetAdoptionStates",
                column: "CurrentState");

            migrationBuilder.CreateIndex(
                name: "IX_PetAdoptionStates_PetId",
                table: "PetAdoptionStates",
                column: "PetId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VolunteerAssignments_ShelterId",

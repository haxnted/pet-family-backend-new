...
public sealed class FullNameTests : UnitTestBase
{
	...
	public void Of_WithValidData_ShouldCreateFullName(
		string name,
		string surname,
		string? patronymic)
	{
	...
	public void Of_WithEmptyName_ShouldThrowException(
		string? name,
		string surname,
		string? patronymic)
	{
	...
	public void Of_WithEmptySurname_ShouldThrowException(
		string name,
		string? surname,
		string? patronymic)
	{
